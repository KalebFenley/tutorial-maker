...
draw.line(
    (cursor_size // 2, 0, cursor_size // 2, cursor_size), fill=(255, 0, 0, 255), width=2
)
draw.line(
    (0, cursor_size // 2, cursor_size, cursor_size // 2), fill=(255, 0, 0, 255), width=2
)

# Create a semi-transparent blue circle to highlight the cursor
highlight_size = 100  # Make the highlight larger

highlight_image = Image.new(
    "RGBA", (highlight_size, highlight_size), (0, 0, 0, 0)
